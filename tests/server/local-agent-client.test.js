/**
 * tests/server/local-agent-client.test.js
 *
 * Unit tests for lib/agents/local-agent-client.js and lib/agents/orchestrator.js
 *
...
describe("LocalAgentClient — module structure", () => {
  it("exports expected symbols", async () => {
    const mod = await import("../../lib/agents/local-agent-client.js");
  ...
  it("DEFAULTS.ollama.models has GLM-5.1:cloud as first choice", async () => {
    const { DEFAULTS } = await import("../../lib/agents/local-agent-client.js");
...
describe("askLocalAgentAboutCode", () => {
  it("sends file content + question and returns answer", async () => {
    const { askLocalAgentAboutCode, LocalAgentClient } = await import("../../lib/agents/local-agent-client.js");
...
describe("proposeCodeEdit", () => {
  it("returns proposedPatch when agent returns a diff", async () => {
    const { proposeCodeEdit, LocalAgentClient } = await import("../../lib/agents/local-agent-client.js");
