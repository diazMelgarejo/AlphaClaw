...
const isValidCronSchedule = (value) => {
  ...
  // Only allow numeric tokens: digits, wildcards, ranges, steps, and comma lists.
  // Named tokens (MON, SUN, JAN, etc.) are not supported by the managed scheduler
  // parser and would silently cause sync to never run on macOS.
