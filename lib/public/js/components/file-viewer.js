                                  ...
                                  ${sqliteSelectedTable
                                    ? html`
                                        <div class="file-viewer-sqlite-table-header">
                                          <span class="file-viewer-sqlite-table-name">${sqliteSelectedTable}</span>
                                          <div class="file-viewer-sqlite-table-nav">
                                            ...
                                            <button
                                              ...
                                              onclick=${() =>
                                                setSqliteTableOffset((previousOffset) =>
                                                  previousOffset + kSqlitePageSize,
                                                )}
                                            >
                                              Next
                                            </button>
                                            ...
                                            : html`
                                                <div class="file-viewer-sqlite-table-wrap">
                                                  <table class="file-viewer-sqlite-table">
                                                    ...
                                                    <tbody>
                                                      ${sqliteRows.length
                                                        ? sqliteRows.map((row, rowIndex) => html`
                                                            <tr key=${rowIndex}>
                                                        ...
                                                        : html`
                                                            <tr>
                                                              <td colspan=${Math.max(1, sqliteColumns.length)}>
                                                                <span class="file-viewer-sqlite-table-empty">No rows</span>
                                                              </td>
                                                            </tr>
                                                          `}
                                                    </tbody>
