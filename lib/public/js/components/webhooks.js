        ...
        ? html`
            ...
            >
              ...
              ${selectedWebhookManaged
                ? html`
                    <div
                      class="rounded-lg border border-cyan-500/30 bg-cyan-500/10 p-3"
                    >
              ...
              <div class="flex items-center justify-between gap-3">
                ...
                <${ActionButton}
                  onClick=${() => {
                    if (selectedWebhookManaged) return;
                    if (deleting) return;
                    setDeleteTransformDir(true);
                    setShowDeleteConfirm(true);
                  }}
                  disabled=${deleting || selectedWebhookManaged}
                  loading=${deleting}
                  tone="danger"
                  size="sm"
                  idleLabel=${selectedWebhookManaged ? "Managed" : "Delete"}
