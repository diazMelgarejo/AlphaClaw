  ...
  try {
    ...
    if (nextDraftPaths.size > 0) {
      window.localStorage.setItem(
        ...
        JSON.stringify(Array.from(nextDraftPaths).sort((left, right) => left.localeCompare(right))),
      );
    }
...
const collectAncestorFolderPaths = (targetPath) => {
